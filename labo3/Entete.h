...
struct TSolution						//**Definition d'une solution: 
{
	...
	bool Valide=false;					//**Etat de validit� de la solution: respect des contraintes de precedence + si chaque ville est presente une et une seule fois. Verifie lorsque la solution est evaluee
