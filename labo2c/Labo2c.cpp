...
int main(int NbParam, char *Param[])
{
	...
	do
	{
		...
		if (Next.FctObj < Courante.FctObj)	//**deplacement amelioration (nous pourrions également considerer l'egalite) 
		{
			Courante = Next;
...
TSolution AppliquerVoisinage(const TSolution uneSol, TProblem unProb, TAlgo& unAlgo)
{
	//Type (structure) de voisinage : 	Echange - Echange de 2 unités selectionnees aleatoirement	
	TSolution Copie;
